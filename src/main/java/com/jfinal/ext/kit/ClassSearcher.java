...
public class ClassSearcher {
    ...
    public static ClassSearcher me = new ClassSearcher();
    ...
    public ClassSearcher addJar(String jar) {
        if(StringKit.notBlank(jar)){
            includeJars.add(jar);
        }
        return this;
    }
    public ClassSearcher addJars(List<String> jars) {
        if(!jars.isEmpty()){
    ...
    public <T> List<Class<? extends T>> search(Class<T> clazz) {
