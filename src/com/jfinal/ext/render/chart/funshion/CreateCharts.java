...
public class CreateCharts {
	...
	protected final static Logger logger = Logger.getLogger(CreateCharts.class);
...
//		}
		...
		String chartCode = charts.createChartHTML(chart.getCharUrl(), "", strXML, "myNext", chart.getCharWidth(),
				chart.getCharHigh(), false);
		return chartCode;
	}
	...
	public static String createPieChart(PieChart chart) {
		...
		String chartCode = charts.createChartHTML(chart.getCharUrl(), "", strXML, "chartId", chart.getCharWidth(),
				chart.getCharHigh(), false);
		return chartCode;
	}
	...
	public static String createMultiCharts(GraphChart multiCharts) {
		...
		String chartCode = charts.createChartHTML(multiCharts.getCharUrl(), "", strXML.toString(), "myNext",
				multiCharts.getCharWidth(), multiCharts.getCharHigh(), false);
		return chartCode;
	}
}
